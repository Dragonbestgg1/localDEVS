  ...
  <div id="bg" class="relative w-full min-h-screen bg-no-repeat bg-cover bg-center transition-all duration-700 filter"
    ...
    <div class="relative z-10 flex flex-col min-h-screen">
      ...
      <main class="relative flex flex-1">
        <!-- Absolutely Positioned Hero Container with Slide Animation -->
  ...
  <script>
    ...
    function changeSlide(index) {
      ...
      newContainer.className =
        "hero slide-hero absolute top-1/2 left-1/2 text-left max-w-full sm:max-w-3xl text-white transition-all duration-700 ease-in-out fade-in z-20 p-4 mx-4";
