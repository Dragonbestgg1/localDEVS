<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            <div id="competition-details" class="text-gray-900 dark:text-gray-100 text-base space-y-6">
    ...
    <script>
        ...
        function loadCompetitionDetails() {
            ...
            if (competition.tasks && competition.tasks.length > 0) {
                ...
                tasksHTML = `<p class="text-lg">No tasks available for this competition.</p>`;
            }
